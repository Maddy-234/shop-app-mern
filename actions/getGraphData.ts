...
export default async function getGraphData() {
    try {
        ...
        //Query the database to get the orders data grouped by createdDate
        ...
        //Initailize an object to aggregate the data by day
        ...
        while (currentDate <= endDate) {
            ...
            //Initialize the aggregated data for the day with the day, date and toatlAmount
            aggregatedData[day] = {
                day,
